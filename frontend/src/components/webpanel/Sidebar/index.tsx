...
const menus = [
  ...
  { title: "Banner", url: "/webpanel/cover" },
  { title: "Service", url: "/webpanel/service" },
  { title: "About Us", url: "/webpanel/about-us" },
  { title: "Contact", url: "/webpanel/contact" },
  // {title:'Home',url:"/webpanel/home"},
];
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const { user, onLogOut }: any = useContext(LogInContext);
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/webpanel/cover"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("cover") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <IoMdImages />
                  Banner
                      ...
                      <React.Fragment>
                        ...
                        >
                          <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                            <li>
                              <Link
                                href="/webpanel/settings/user"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/webpanel/settings/user" &&
                                  "text-white"
                                }`}
                              >
                                Users
                            ...
                            {user?.role === "super" && (
                              <>
                                <li>
                                  <Link
                                    href="/webpanel/settings/seo"
                                    className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                      pathname === "/webpanel/settings/seo" &&
                                      "text-white"
                                    } `}
                                  >
                                    Seo Optimize
                                ...
                                <li>
                                  <Link
                                    href="/webpanel/settings/log"
                                    className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                      pathname === "/webpanel/settings/log" &&
                                      "text-white"
                                    } `}
                                  >
                                    Activity Logs
