...
export default function UserForm({ type, data, setData }: any) {
  ...
  const onCreate = async (data: any) => {
    onSave(data, "POST", null, "user", `Create New User:${data?.username}`);
  };
  const onEdit = async (formData: any) => {
    ...
    onSave(
      ...
      data?.id,
      "user",
      `Update User:${modifiedData?.username}`
    );
  };
      ...
      <div className="flex flex-wrap items-center">
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form
              onSubmit={handleSubmit(type === "create" ? onCreate : onEdit)}
            >
              <div className="mb-4">
                <div className="mb-4.5">
                  ...
                  <div className="relative z-20 bg-transparent dark:bg-form-input">
                    <select
                      ...
                      value={create ? selectedOption : data?.role}
                      onChange={(e) => {
                        create
                ...
                <div className="relative">
                  <input
                    ...
                    value={edit ? data?.username : undefined}
                    onChange={(e: any) =>
                      edit &&
                      setData((prev: any) => ({
                        ...prev,
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    value={edit ? data?.email : undefined}
                    type="email"
